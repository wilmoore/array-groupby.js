# Contributing to array-groupby

Below are a few ways to make contributing to `array-groupby` smoother.
...
## Setup
    ...
    git clone https://github.com/wilmoore/array-groupby.js.git
    cd array-groupby.js
    npm install
    npm run dev
